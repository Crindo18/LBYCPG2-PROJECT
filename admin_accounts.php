...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .password-display { background: #f8f9fa; padding: 15px; border-radius: 5px; margin: 15px 0; font-family: monospace; font-size: 18px; text-align: center; border: 2px solid #6a1b9a; color: #6a1b9a; font-weight: bold; }
        .section-title { font-size: 16px; font-weight: 600; color: #6a1b9a; margin-top: 20px; margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #e0e0e0; }
    </style>
</head>
<body>
    <div class="container">
